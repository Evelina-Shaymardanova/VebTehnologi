...
$skills = [
  ['name' => 'Сантехника', 'percent' => 92],
  ['name' => 'Ремонт стиральной машины', 'percent' => 80],
  ['name' => 'Замена счетчиков', 'percent' => 75],
  ['name' => 'Ремонт санузла', 'percent' => 50],
];

$workExperience = [
  [
    'jobTitle' => 'Мастер на все руки',
    'periodStart' => 'Jan 2022',
    'periodFinish' => 'Current',
    'description' => 'По рекомендациям работодателя зарекомендовал себя как хороший работник. Два года подряд становился работником года'
  ],
  [
    'jobTitle' => 'Сантехник/Слесарь',
    'periodStart' => 'Mar 2012',
    'periodFinish' => 'Dec 2021',
    'description' => 'Проработав столько лет в компании, 5 лет подряд был удостоин премией и работником года.'
  ],
  [
    'jobTitle' => 'Слесарь',
    'periodStart' => 'Jun 2010',
    'periodFinish' => 'Mar 2012',
    'description' => 'На протяжении всего времени работы, параллельно проходил дополнительные обучающие курсы по сантехнике'
  ],
];
?>
